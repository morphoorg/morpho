...
class PyStanBaseProcessor(BaseProcessor):
    '''
    Base processor that will call PyStan.
    Processors using pystan feature should be derived from this class.
