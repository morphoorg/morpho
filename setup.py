...
setup(
    ...
    scripts=['bin/morpho'],
    install_requires=['h5py<=2.6','colorlog','PyYAML<=3.11','pyparsing<=2.1.5','numpy<=1.11.*','pystan<=2.14','dnspython<=1.12.0','pbr<=0.10.8','wsgiref<=0.1.2','cycler<=0.10.0','python-dateutil<=2.5.3','matplotlib'],
